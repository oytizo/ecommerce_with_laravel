                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="language-dropdown-active" href="#">USD <i class="fi-rs-angle-small-down"></i></a>
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-fr.png" alt="">INR</a></li>
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-dt.png" alt="">MBP</a></li>
                                        <li><a href="#"><img src="{{ asset('frontend') }}/imgs/theme/flag-ru.png" alt="">EU</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-1.svg" alt="">Milks and Dairies</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-2.svg" alt="">Clothing & beauty</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-3.svg" alt="">Pet Foods & Toy</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-4.svg" alt="">Baking material</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-5.svg" alt="">Fresh Fruit</a></li>
                                    </ul>
                                    <ul class="end">
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-6.svg" alt="">Wines & Drinks</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-7.svg" alt="">Fresh Seafood</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-8.svg" alt="">Fast food</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-9.svg" alt="">Vegetables</a></li>
                                        <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-10.svg" alt="">Bread and Juice</a></li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none;">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/icon-1.svg" alt="">Milks and Dairies</a></li>
                                            <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/icon-2.svg" alt="">Clothing & beauty</a></li>
                                        </ul>
                                        <ul class="end">
                                            <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/icon-3.svg" alt="">Wines & Drinks</a></li>
                                            <li><a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/icon-4.svg" alt="">Fresh Seafood</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                ...
                                <tr class="pt-30">
                                    ...
                                    <td class="image product-thumbnail pt-40"><img src="{{ asset('backend/items/'.$item->pic) }}" alt="#"></td>
