		                    ...
		                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
		                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
		                            <div class="product-img-action-wrap">
		                                <div class="product-img product-img-zoom">
		                                    <a href="shop-product-right.html">
		                                        <img class="default-img" src="{{ asset('backend/items/'.$items->pic) }}" alt="">
		                                        <img class="hover-img" src="{{ asset('backend/items/'.$items->pic) }}" alt="">
		                                    </a>
		                                </div>
		                            ...
		                            <div class="product-content-wrap">
		                                ...
		                                <h2><a href="shop-product-right.html">{{ $items->name }}</a></h2>
		                                ...
		                                <div class="product-card-bottom">
                                            ...
                                            <input type="hidden" class="name{{ $items->id }}" value="{{ $items->name }}">
                                            <input type="hidden" class="pid{{ $items->id }}" value="{{ $items->id }}">
                                            <input type="hidden" class="price{{ $items->id }}" value="{{ $items->salePrice }}">
                                            <input type="hidden" class="disPrice{{ $items->id }}" value="{{ $items->disPrice }}">
                                            <input type="hidden" class="pic{{ $items->id }}" value="{{ $items->pic }}">
                                            <input type="hidden" class="qty{{ $items->id }}" value="{{ $items->qty }}">
		                                        <span>${{ $items->salePrice }}</span>
		                                        <span class="old-price">${{ $items->disPrice }}</span>
		                                    </div>
		                                    <div class="add-cart">
		                                        <button class="add addcart{{ $items->id }}" href="shop-cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </button>
		                                    </div>
		                                </div>
		                            </div>
		                        </div>
