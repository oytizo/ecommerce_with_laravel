            ...
            <table class="table border-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->cat->name }}</td>
                        <td>{{ $data->des }}</td>
                        <td><img height="40" src="{{ asset('backend/subcategoryimages/'.$data->img) }}" alt=""></td>
                        <td>
                            @if($data->status==1)
                        ...
                        <td>
                            <a href="{{ Route('subcategoryproductedit',$data->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
